...
- [📑 Menü](#-menü)
- [🖼️ Vakalar](#️-vakalar)
  - [Vaka 1: İllüstrasyondan Figüre（geliştiren @ZHO_ZHO_ZHO）](#vaka-1-i̇llüstrasyondan-figüregeliştiren-zho_zho_zho)
  - [Vaka 2: Harita Okundan Yer Görünümü Oluşturma（geliştiren @tokumin）](#vaka-2-harita-okundan-yer-görünümü-oluşturmageliştiren-tokumin)
  - [Vaka 3: Gerçek Dünya AR Bilgileri（geliştiren @bilawalsidhu）](#vaka-3-gerçek-dünya-ar-bilgilerigeliştiren-bilawalsidhu)
  - [Vaka 4: 3B Binaları Çıkarma/İzometrik Modeller Yapma（geliştiren @Zieeett）](#vaka-4-3b-binaları-çıkarmai̇zometrik-modeller-yapmageliştiren-zieeett)
  - [Vaka 5: Farklı Dönemlerdeki Fotoğraflarınız（geliştiren @AmirMushich）](#vaka-5-farklı-dönemlerdeki-fotoğraflarınızgeliştiren-amirmushich)
  - [Vaka 6: Çok Referanslı Görüntü Oluşturma（geliştiren @MrDavids1）](#vaka-6-çok-referanslı-görüntü-oluşturmageliştiren-mrdavids1)
  - [Vaka 7: Otomatik Fotoğraf Düzenleme（geliştiren @op7418）](#vaka-7-otomatik-fotoğraf-düzenlemegeliştiren-op7418)
  - [Vaka 8: El Çizimi Çoklu Karakter Pozlarını Kontrol Eder（geliştiren @op7418）](#vaka-8-el-çizimi-çoklu-karakter-pozlarını-kontrol-edergeliştiren-op7418)
  - [Vaka 9: Çapraz Görüşlü Görüntü Oluşturma（geliştiren @op7418）](#vaka-9-çapraz-görüşlü-görüntü-oluşturmageliştiren-op7418)
  - [Vaka 10: Özel Karakter Çıkartmaları（geliştiren @op7418）](#vaka-10-özel-karakter-çıkartmalarıgeliştiren-op7418)
  - [Vaka 11: Anime'den Gerçek Cosplayer'a（geliştiren @ZHO_ZHO_ZHO）](#vaka-11-animeden-gerçek-cosplayera-geliştiren-zho_zho_zho)
  - [Vaka 12: Karakter Tasarımı Oluşturma（geliştiren @ZHO_ZHO_ZHO）](#vaka-12-karakter-tasarımı-oluşturmageliştiren-zho_zho_zho)
  - [Vaka 13: Renk Paleti ile Çizgi Sanatını Renklendirme（geliştiren @ZHO_ZHO_ZHO）](#vaka-13-renk-paleti-ile-çizgi-sanatını-renklendirmegeliştiren-zho_zho_zho)
  - [Vaka 14: Makale İnfografiği（geliştiren @黄建同学）](#vaka-14-makale-i̇nfografiğigeliştiren-黄建同学)
  - [Vaka 15: Birden Fazla Saç Stilini Değiştirme（geliştiren @balconychy）](#vaka-15-birden-fazla-saç-stilini-değiştirmegeliştiren-balconychy)
  - [Vaka 16: Model Ek Açıklama Şeması（geliştiren @berryxia_ai）](#vaka-16-model-ek-açıklama-şemasıgeliştiren-berryxia_ai)
  - [Vaka 17: Özel Mermer Heykel（geliştiren @umesh_ai）](#vaka-17-özel-mermer-heykelgeliştiren-umesh_ai)
  - [Vaka 18: Malzemelere Göre Yemek Pişirme（geliştiren @Gdgtify）](#vaka-18-malzemelere-göre-yemek-pişirmegeliştiren-gdgtify)
  - [Vaka 19: Matematik Problemi Akıl Yürütme（geliştiren @Gorden Sun）](#vaka-19-matematik-problemi-akıl-yürütmegeliştiren-gorden-sun)
  - [Vaka 20: Eski Fotoğraf Renklendirme（geliştiren @GeminiApp）](#vaka-20-eski-fotoğraf-renklendirmegeliştiren-geminiapp)
  - [Vaka 21: OOTD Kıyafeti（geliştiren @302.AI）](#vaka-21-ootd-kıyafetigeliştiren-302ai)
  - [Vaka 22: Karakter Kıyafet Değişikliği（geliştiren @skirano）](#vaka-22-karakter-kıyafet-değişikliğigeliştiren-skirano)
  - [Vaka 23: Çoklu Görünüm Sonuç Üretimi（geliştiren @Error_HTTP_404）](#vaka-23-çoklu-görünüm-sonuç-üretimigeliştiren-error_http_404)
  - [Vaka 24: Film Hikaye Taslağı（geliştiren @GeminiApp）](#vaka-24-film-hikaye-taslağıgeliştiren-geminiapp)
  - [Vaka 25: Karakter Pozu Değişikliği（geliştiren @arrakis_ai）](#vaka-25-karakter-pozu-değişikliğigeliştiren-arrakis_ai)
  - [Vaka 26: Çizgi çiziminden resim oluşturma（geliştiren @ZHO_ZHO_ZHO）](#vaka-26-çizgi-çiziminden-resim-oluşturmageliştiren-zho_zho_zho)
  - [Vaka 27: Resme Filigran Ekleme（geliştiren @AiMachete）](#vaka-27-resme-filigran-eklemegeliştiren-aimachete)
  - [Vaka 28: Bilgiye Dayalı Akıl Yürütme ile Görüntü Oluşturma（geliştiren @icreatelife）](#vaka-28-bilgiye-dayalı-akıl-yürütme-ile-görüntü-oluşturmageliştiren-icreatelife)
  - [Vaka 29: Kırmızı Kalemle Düzeltmeler（geliştiren @AiMachete）](#vaka-29-kırmızı-kalemle-düzeltmelergeliştiren-aimachete)
  - [Vaka 30: Patlayan Yiyecek（geliştiren @icreatelife）](#vaka-30-patlayan-yiyecekgeliştiren-icreatelife)
  - [Vaka 31: Çizgi Roman Oluşturma（geliştiren @icreatelife）](#vaka-31-çizgi-roman-oluşturmageliştiren-icreatelife)
  - [Vaka 32: Aksiyon Figürü（geliştiren @icreatelife）](#vaka-32-aksiyon-figürügeliştiren-icreatelife)
  - [Vaka 33: Haritadan İzometrik Binalara（geliştiren @demishassabis）](#vaka-33-haritadan-i̇zometrik-binalarageliştiren-demishassabis)
  - [Vaka 34: Referans Görüntü Karakter İfadesini Kontrol Eder（geliştiren @ZHO_ZHO_ZHO）](#vaka-34-referans-görüntü-karakter-i̇fadesini-kontrol-edergeliştiren-zho_zho_zho)
  - [Vaka 35: İllüstrasyon Çizim Süreci Dört Paneli（geliştiren @ZHO_ZHO_ZHO）](#vaka-35-i̇llüstrasyon-çizim-süreci-dört-paneligeliştiren-zho_zho_zho)
  - [Vaka 36: Sanal Makyaj Denemesi（geliştiren @ZHO_ZHO_ZHO）](#vaka-36-sanal-makyaj-denemesigeliştiren-zho_zho_zho)
  - [Vaka 37: Makyaj Analizi（geliştiren @ZHO_ZHO_ZHO）](#vaka-37-makyaj-analizigeliştiren-zho_zho_zho)
  - [Vaka 38: Orta Dünya'nın Google Haritalar Görünümü（geliştiren @TechHallo）](#vaka-38-orta-dünyanın-google-haritalar-görünümügeliştiren-techhallo)
  - [Vaka 39: Tipografik İllüstrasyon Üretimi（geliştiren @Umesh）](#vaka-39-tipografik-i̇llüstrasyon-üretimigeliştiren-umesh)
  - [Vaka 40: Çoklu Karakter Pozları Üretimi（geliştiren @tapehead_Lab）](#vaka-40-çoklu-karakter-pozları-üretimigeliştiren-tapehead_lab)
  - [Vaka 41: Ürün Ambalajı Üretimi（geliştiren @ZHO_ZHO_ZHO）](#vaka-41-ürün-ambalajı-üretimigeliştiren-zho_zho_zho)
  - [Vaka 42: Filtre/Malzeme Yerleşimi（geliştiren @ZHO_ZHO_ZHO）](#vaka-42-filtemalzeme-yerleşimigeliştiren-zho_zho_zho)
  - [Vaka 43: Karakter Yüz Şeklini Kontrol Etme（geliştiren @ZHO_ZHO_ZHO）](#vaka-43-karakter-yüz-şeklini-kontrol-etmegeliştiren-zho_zho_zho)
  - [Vaka 44: Aydınlatma Kontrolü（geliştiren @ZHO_ZHO_ZHO）](#vaka-44-aydınlatma-kontrolügeliştiren-zho_zho_zho)
  - [Vaka 45: LEGO Minifigürü（geliştiren @ZHO_ZHO_ZHO）](#vaka-45-lego-minifigürügeliştiren-zho_zho_zho)
  - [Vaka 46: Gundam Model Figürü（geliştiren @ZHO_ZHO_ZHO）](#vaka-46-gundam-model-figürügeliştiren-zho_zho_zho)
  - [Vaka 47: Donanım Patlatılmış Görünümü（geliştiren @AIimagined）](#vaka-47-donanım-patlatılmış-görünümügeliştiren-aiimagined)
  - [Vaka 48: Yiyecek Kalori Notasyonu（geliştiren @icreatelife）](#vaka-48-yiyecek-kalori-notasyonugeliştiren-icreatelife)
  - [Vaka 49: Konuyu Çıkar ve Şeffaf Katmana Yerleştir（geliştiren @nglprz）](#vaka-49-konuyu-çıkar-ve-şeffaf-katmana-yerleştirgeliştiren-nglprz)
  - [Vaka 50: Görüntü Dış Boyama Onarımı（geliştiren @bwabbage）](#vaka-50-görüntü-dış-boyama-onarımıgeliştiren-bwabbage)
  - [Vaka 51: Antik Harita → Tarihi Sahne Fotoğrafı（geliştiren @levelsio）](#vaka-51-antik-harita--tarihi-sahne-fotoğrafıgeliştiren-levelsio)
  - [Vaka 52: Moda Moodboard Kolajı（geliştiren @tetumemo）](#vaka-52-moda-moodboard-kolajıgeliştiren-tetumemo)
  - [Vaka 53: Zarif Sevimli Ürün Fotoğrafı（geliştiren @azed_ai）](#vaka-53-zarif-sevimli-ürün-fotoğrafıgeliştiren-azed_ai)
  - [Vaka 54: Anime Heykelini Gerçek Hayata Yerleştirme（geliştiren @riddi0908）](#vaka-54-anime-heykelini-gerçek-hayata-yerleştirmegeliştiren-riddi0908)
  - [Vaka 55: Bir Itasha Arabası Oluşturma（geliştiren @riddi0908）](#vaka-55-bir-itasha-arabası-oluşturmageliştiren-riddi0908)
  - [Vaka 56: Manga Kompozisyonu（geliştiren @namaedousiyoka）](#vaka-56-manga-kompozisyonugeliştiren-namaedousiyoka)
  - [Vaka 57: Manga Stili Dönüşümü（geliştiren @nobisiro_2023）](#vaka-57-manga-stili-dönüşümügeliştiren-nobisiro_2023)
  - [Vaka 58: İzometrik Holografik Tel Çerçeve（geliştiren @tetumemo）](#vaka-58-i̇zometrik-holografik-tel-çerçevegeliştiren-tetumemo)
  - [Vaka 59: Minecraft Tarzı Sahne Oluşturma（geliştiren @tetumemo）](#vaka-59-minecraft-tarzı-sahne-oluşturmageliştiren-tetumemo)
  - [Vaka 60: Malzeme Küresini Logoya Uygulama（geliştiren @ZHO_ZHO_ZHO）](#vaka-60-malzeme-küresini-logoya-uygulamageliştiren-zho_zho_zho)
  - [Vaka 61: Kat Planı 3D Render（geliştiren @op7418）](#vaka-61-kat-planı-3d-rendergeliştiren-op7418)
  - [Vaka 62: Kamera Parametrelerini Sıfırlama（geliştiren @hckinz）](#vaka-62-kamera-parametrelerini-sıfırlamageliştiren-hckinz)
  - [Vaka 63: Vesikalık Fotoğraf Oluşturma（geliştiren @songguoxiansen）](#vaka-63-vesikalık-fotoğraf-oluşturmageliştiren-songguoxiansen)
  - [Vaka 64: Sahne A6 Katlanır Kart（geliştiren @Gdgtify）](#vaka-64-sahne-a6-katlanır-kartgeliştiren-gdgtify)
  - [Vaka 65: Bir Satranç Takımı Tasarlama（geliştiren @Gdgtify）](#vaka-65-bir-satranç-takımı-tasarlamageliştiren-gdgtify)
  - [Vaka 66: Bölünmüş Kontrast Tarzı Fotoğraf（geliştiren @fofrAI）](#vaka-66-bölünmüş-kontrast-tarzı-fotoğrafgeliştiren-fofrai)
  - [Vaka 67: Mücevher Koleksiyonu Tasarımı（geliştiren @Gdgtify）](#vaka-67-mücevher-koleksiyonu-tasarımıgeliştiren-gdgtify)
  - [Vaka 68: Ürün Tasarımı（geliştiren @0xFramer）](#vaka-68-ürün-tasarımıgeliştiren-0xframer)
  ...
  - [Örnek 73: Burger Malzemelerini Çıkarma (geliştiren @bind_lux, vaka @jeanlucaslima tarafından sağlandı)](#örnek-73-burger-malzemelerini-çıkarma-geliştiren-bind_lux-vaka-jeanlucaslima-tarafından-sağlandı)
  ...
  - [Örnek 75: Görüntüden Minyatür Sahne Oluşturma (geliştiren @techhalla)](#örnek-75-görüntüden-minyatür-sahne-oluşturma-geliştiren-techhalla)
  ...
  - [Örnek 78: Kısmen Yenmiş Yiyecekleri Geri Yükleme (geliştiren @googlejapan)](#örnek-78-kısmen-yenmiş-yiyecekleri-geri-yükleme-geliştiren-googlejapan)
  - [Örnek 79: Dövüş Oyunu Arayüzü Oluşturma (geliştiren @NanoBanana_labs)](#örnek-79-dövüş-oyunu-arayüzü-oluşturma-geliştiren-nanobanana_labs)
  - [Örnek 80: Model Kesiti (geliştiren @old_pgmrs_will)](#örnek-80-model-kesiti-geliştiren-old_pgmrs_will)
  - [Örnek 81: Korsan Aranıyor Posteri (geliştiren @AI_Kei75)](#örnek-81-korsan-aranıyor-posteri-geliştiren-ai_kei75)
  - [Örnek 82: Ürün Teşhir Rafı (geliştiren @tokyo_Valentine)](#örnek-82-ürün-teşhir-rafı-geliştiren-tokyo_valentine)
  - [Örnek 83: Çizgi Roman Fuarı Standı (geliştiren @tokyo_Valentine)](#örnek-83-çizgi-roman-fuarı-standı-geliştiren-tokyo_valentine)
  - [Örnek 84: Çizgi Sanatından Karalama Çizimine (geliştiren @hAru_mAki_ch)](#örnek-84-çizgi-sanatından-karalama-çizimine-geliştiren-haru_maki_ch)
  ...
  - [Örnek 87: Siyah Beyaz Evrim Şeması (geliştiren @ZHO_ZHO_ZHO)](#örnek-87-siyah-beyaz-evrim-şeması-geliştiren-zho_zho_zho)
  - [Örnek 88: Cam Şişe Hatıra Eşyası (geliştiren @NanoBanana_labs)](#örnek-88-cam-şişe-hatıra-eşyası-geliştiren-nanobanana_labs)
  - [Örnek 89: Minyatür Mağaza (geliştiren @NanoBanana_labs)](#örnek-89-minyatür-mağaza-geliştiren-nanobanana_labs)
  - [Örnek 90: Vtuber Olmak (geliştiren @AI_Kei75)](#örnek-90-vtuber-olmak-geliştiren-ai_kei75)
  - [Örnek 91: Tren İstasyonu Film Posteri (geliştiren @AI_Kei75)](#örnek-91-tren-i̇stasyonu-film-posteri-geliştiren-ai_kei75)
